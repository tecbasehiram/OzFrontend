...
import { customConfirm, customAlert, customToast } from  "../modulos/modals.js";
...
export function createModals() {
    ...
    <div class="modal fade" id="modal-alert" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modal-alert-label" aria-hidden="true" style="z-index: 10000000; ">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-sm">
            <div class="modal-content" style="background-color: #295e4e;">
                <div class="modal-body">
                    <h1 class="modal-title fs-5" id="modal-alert-label" style="color: white !important;">Este é um alerta!</h1>
                </div>
                <div class="modal-footer">
                    <button type="button" id="btn-alert-ok" class="btn" style="background: linear-gradient(to right, #e3cb6f, #c9af5f); box-shadow: 0 0 5px #e3cb6f; color: #295e4e;">Ok</button>
                </div>
            </div>
        </div>
    </div>
    <div class="modal fade" id="modal-confirm" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modal-confirm-label" aria-hidden="true" style="z-index: 10000000;">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content" style="background-color: #295e4e;">
                <div class="modal-body">
                    <h1 class="modal-title fs-5" id="modal-confirm-label" style="color: white !important;">Este é um confirm!</h1>
                </div>
                <div class="modal-footer">
                    ...
                    <button type="button" id="btn-confirm-sim" class="btn" style="background: linear-gradient(to right, #e3cb6f, #c9af5f); box-shadow: 0 0 5px #e3cb6f; color: #295e4e;">Sim</button>
                </div>
            </div>
        </div>
    </div>`;
...
export function createFooterAreaLogada(nivel) {
    const footerHTML = `
            ...
            <div class="footer-container d-flex align-items-center justify-content-between py-4 flex-md-row flex-column">
                <div class="d-flex flex-row justify-content-between w-100">
                    <div class="mb-2 mb-md-0">
                        ...
                        <a href="#" class="text-gray">Oz Viagens e Turismo,</a>
                        <span class="footer-bottom-text"> Todos os direitos reservados à Hiram Inteligência e Negócios e licenciados à Oz Viagens e Turismo.</span>
                    </div>
                    <a href="#" class="footer-link" style="margin-left: 10px; text-decoration: none; ">
                        Suporte
                    </a>
                </div>
            </div>
    ...
    if (layoutFooterElement) {
        ...
        layoutFooterElement.querySelector(".footer-link").addEventListener("click", () => {
            customAlert(`
                Caso precise de suporte IMEDIATO, envie um email para <a href="#" class="copiar-email text-white">adm@ozviagenseturismo.com.br</a><i class="fa-regular fa-copy copiar-email" style="cursor:pointer; margin-left: 5px;"></i>.
            `, null, false);
            ...
            document.querySelectorAll('.copiar-email').forEach(link => {
                link.addEventListener('click', async (e) => {
                    e.preventDefault();
                    try {
                        await navigator.clipboard.writeText('adm@ozviagenseturismo.com.br');
                        customToast("E-mail copiado para a área de transferência");
                    } catch (err) {
...
export function createSidebar(nivel, paginaAtual) {
        ...
        <a class="app-brand-link" style="width: 100%; display: flex;" href="${nivel}/area-restrita/bem-vindo/bem-vindo-page.html">
            <span class="app-brand-logo demo w-100 h-auto" style="display: flex; justify-content: center;">
                <span class="text-primary alvo" style="width: 100% !important; display: flex; justify-content: center;"">
                    <img
                    src="${nivel}/assets/images/Logo-OZ-verde_2.png"
                    alt="logo"
                    class="app-brand-logo demo logo-sidebar mt-1 mb-1"
                    style="width: 30%; heigth: auto;" />
                </span>
            </span>
    ...
    function updateLogoBasedOnTheme() {
        ...
        if (logo) {
            logo.src = isDark
            ? `${nivel}/assets/images/Logo-OZ-verde_2.png`
            : `${nivel}/assets/images/Logo-OZ-verde_2.png`;
        }
