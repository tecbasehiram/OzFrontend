...
async function carregarEventos() {
  try {
    const response = await fetch('./personalizacoes/eventos-calendario/eventos-calendario.json?v=' + Date.now())
